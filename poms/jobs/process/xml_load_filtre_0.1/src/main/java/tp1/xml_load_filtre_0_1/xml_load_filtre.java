...
package tp1.xml_load_filtre_0_1;
...
/**
 * Job: xml_load_filtre Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class xml_load_filtre implements TalendJob {
	...
	private final String jobName = "xml_load_filtre";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_load_filtre.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_load_filtre.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class departement_mapedStruct implements routines.system.IPersistableRow<departement_mapedStruct> {
		final static byte[] commonByteArrayLock_TP1_xml_load_filtre = new byte[0];
		static byte[] commonByteArray_TP1_xml_load_filtre = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_load_filtre.length) {
					if (length < 1024 && commonByteArray_TP1_xml_load_filtre.length == 0) {
						commonByteArray_TP1_xml_load_filtre = new byte[1024];
					} else {
						commonByteArray_TP1_xml_load_filtre = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_load_filtre, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_filtre, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_load_filtre, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_filtre, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_load_filtre) {
	...
	public void tFileInputXML_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "NUMERO", "DEPARTEMENT", "PREFECTURE", "REGION", });
...
// # Output table : 'departement_maped'
								departement_maped_tmp.NUMERO = Interger.Tryparse(row1.NUMERO)
										? Integer.parseInt(row1.NUMERO)
										: 20;
...
///////////////////////		
								...
								if (departement_maped.NUMERO != null) { //
									row_tLogRow_1[0] = String.valueOf(departement_maped.NUMERO);

								} //

								if (departement_maped.DEPARTEMENT != null) { //
									row_tLogRow_1[1] = String.valueOf(departement_maped.DEPARTEMENT);

								} //

								if (departement_maped.PREFECTURE != null) { //
									row_tLogRow_1[2] = String.valueOf(departement_maped.PREFECTURE);

								} //

								if (departement_maped.REGION != null) { //
									row_tLogRow_1[3] = String.valueOf(departement_maped.REGION);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final xml_load_filtre xml_load_filtreClass = new xml_load_filtre();

		int exitCode = xml_load_filtreClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_load_filtre.class.getClassLoader()
					.getResourceAsStream("tp1/xml_load_filtre_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_load_filtre.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_load_filtre");
		}
...
/************************************************************************************************
 * 66251 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 22:50:25 CET
 ************************************************************************************************/