...
package tp1.xml_load_filter_numero_0_1;
...
/**
 * Job: xml_load_filter_numero Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class xml_load_filter_numero implements TalendJob {
	...
	private final String jobName = "xml_load_filter_numero";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_load_filter_numero.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_load_filter_numero.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_xml_load_filter_numero = new byte[0];
		static byte[] commonByteArray_TP1_xml_load_filter_numero = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_load_filter_numero.length) {
					if (length < 1024 && commonByteArray_TP1_xml_load_filter_numero.length == 0) {
						commonByteArray_TP1_xml_load_filter_numero = new byte[1024];
					} else {
						commonByteArray_TP1_xml_load_filter_numero = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_load_filter_numero, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_filter_numero, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_load_filter_numero, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_filter_numero, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_load_filter_numero) {
...
// Start of branch "row1"
						if (row1 != null) {
							...
							ope_tFilterRow_2.matches((row1.NUMERO == null ? false : row1.NUMERO.compareTo("20") > 0),
							...
							if (ope_tFilterRow_2.getMatchFlag()) {
								...
								row2.DEPARTEMENT = row1.DEPARTEMENT;
								row2.PREFECTURE = row1.PREFECTURE;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final xml_load_filter_numero xml_load_filter_numeroClass = new xml_load_filter_numero();

		int exitCode = xml_load_filter_numeroClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_load_filter_numero.class.getClassLoader()
					.getResourceAsStream("tp1/xml_load_filter_numero_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_load_filter_numero.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_load_filter_numero");
		}
...
/************************************************************************************************
 * 65688 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 23:12:01 CET
 ************************************************************************************************/