...
package tp1.webvelo_trestclient_list_0_1;
...
/**
 * Job: WebVelo_TRestClient_List Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class WebVelo_TRestClient_List implements TalendJob {
	...
	private final String jobName = "WebVelo_TRestClient_List";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					WebVelo_TRestClient_List.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WebVelo_TRestClient_List.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_WebVelo_TRestClient_List = new byte[0];
		static byte[] commonByteArray_TP1_WebVelo_TRestClient_List = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_WebVelo_TRestClient_List.length) {
					if (length < 1024 && commonByteArray_TP1_WebVelo_TRestClient_List.length == 0) {
						commonByteArray_TP1_WebVelo_TRestClient_List = new byte[1024];
					} else {
						commonByteArray_TP1_WebVelo_TRestClient_List = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_WebVelo_TRestClient_List, 0, length);
				strReturn = new String(commonByteArray_TP1_WebVelo_TRestClient_List, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_WebVelo_TRestClient_List, 0, length);
				strReturn = new String(commonByteArray_TP1_WebVelo_TRestClient_List, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_WebVelo_TRestClient_List) {
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/workspace/TP1/dataset-tp1/villes_input.csv", "US-ASCII", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row2.ville = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							globalMap.put("ville", row2.ville);
							...
							String villeIter = (String) globalMap.get("ville");
							System.out.println(villeIter);
...
// expected response body
				...
				try {
					...
					// set request path
					webClient_tRESTClient_1.path("rest/vls/stations/" + (String) globalMap.get("ville") + ".json");
...
///////////////////////		
					...
					if (row1.statusCode != null) { //
						row_tLogRow_1[0] = String.valueOf(row1.statusCode);

					} //

					if (row1.body != null) { //
						row_tLogRow_1[1] = String.valueOf(row1.body);

					} //

					if (row1.string != null) { //
						row_tLogRow_1[2] = String.valueOf(row1.string);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final WebVelo_TRestClient_List WebVelo_TRestClient_ListClass = new WebVelo_TRestClient_List();

		int exitCode = WebVelo_TRestClient_ListClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WebVelo_TRestClient_List.class.getClassLoader()
					.getResourceAsStream("tp1/webvelo_trestclient_list_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WebVelo_TRestClient_List.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : WebVelo_TRestClient_List");
		}
...
/************************************************************************************************
 * 65629 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 19:42:51 CET
 ************************************************************************************************/