...
package tp1.excel_data_filter_0_1;
...
/**
 * Job: excel_data_filter Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_data_filter implements TalendJob {
	...
	private final String jobName = "excel_data_filter";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excel_data_filter.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_data_filter.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_excel_data_filter = new byte[0];
		static byte[] commonByteArray_TP1_excel_data_filter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_excel_data_filter.length) {
					if (length < 1024 && commonByteArray_TP1_excel_data_filter.length == 0) {
						commonByteArray_TP1_excel_data_filter = new byte[1024];
					} else {
						commonByteArray_TP1_excel_data_filter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_excel_data_filter, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_filter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_excel_data_filter, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_filter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_excel_data_filter) {
...
///////////////////////    			
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:enlfLgCPzjkhhW3u0tIiLqcjHFdMYMGz7Q/Buw==");
...
// Start of branch "row1"
							if (row1 != null) {
								...
								ope_tFilterRow_1.matches(
										(row1.CIVILITE__1_M_2_Mme__3_Mlle == null ? false
												: row1.CIVILITE__1_M_2_Mme__3_Mlle.compareTo(
														ParserUtils.parseTo_Integer(String.valueOf(1))) == 0),
										"CIVILITE__1_M_2_Mme__3_Mlle.compareTo(1) == 0 failed");

								ope_tFilterRow_1.matches((row1.Nom == null ? false : row1.Nom.compareTo("DUPONT") < 0),
										"Nom.compareTo(\"DUPONT\") < 0 failed");
								ope_tFilterRow_1.matches(
										(row1.DATE_NAISSANCE == null ? false
												: row1.DATE_NAISSANCE.compareTo(
														TalendDate.parseDate("dd-MM-yyyy", "31-12-1961")) > 0),
										"DATE_NAISSANCE.compareTo(TalendDate.parseDate(\"dd-MM-yyyy\", \"31-12-1961\")) > 0 failed");
...
///////////////////////		
									...
									if (row2.Prenom != null) { //
										row_tLogRow_2[2] = String.valueOf(row2.Prenom);

									} //

									if (row2.CIVILITE__1_M_2_Mme__3_Mlle != null) { //
										row_tLogRow_2[3] = String.valueOf(row2.CIVILITE__1_M_2_Mme__3_Mlle);

									} //

									if (row2.CP != null) { //
										row_tLogRow_2[4] = String.valueOf(row2.CP);

									} //

									if (row2.DATE_NAISSANCE != null) { //
										row_tLogRow_2[5] = FormatterUtils.format_Date(row2.DATE_NAISSANCE,
												"dd-MM-yyyy");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final excel_data_filter excel_data_filterClass = new excel_data_filter();

		int exitCode = excel_data_filterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_data_filter.class.getClassLoader()
					.getResourceAsStream("tp1/excel_data_filter_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_data_filter.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : excel_data_filter");
		}
...
/************************************************************************************************
 * 75556 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 08:43:47 CET
 ************************************************************************************************/