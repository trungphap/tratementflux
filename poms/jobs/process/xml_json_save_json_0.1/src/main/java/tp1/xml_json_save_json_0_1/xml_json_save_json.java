...
package tp1.xml_json_save_json_0_1;
...
/**
 * Job: xml_json_save_json Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class xml_json_save_json implements TalendJob {
	...
	private final String jobName = "xml_json_save_json";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_json_save_json.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_json_save_json.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class croiser_xml_jsonStruct implements routines.system.IPersistableRow<croiser_xml_jsonStruct> {
		final static byte[] commonByteArrayLock_TP1_xml_json_save_json = new byte[0];
		static byte[] commonByteArray_TP1_xml_json_save_json = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_json_save_json.length) {
					if (length < 1024 && commonByteArray_TP1_xml_json_save_json.length == 0) {
						commonByteArray_TP1_xml_json_save_json = new byte[1024];
					} else {
						commonByteArray_TP1_xml_json_save_json = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_json_save_json, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_json_save_json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_json_save_json, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_json_save_json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_json_save_json) {
	...
	public void tFileInputXML_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileOutputJSON_1 = new java.io.File("C:/workspace/TP1/output/croiser_xml_json.json");
				...
				java.io.PrintWriter outtFileOutputJSON_1 = new java.io.PrintWriter(new java.io.BufferedWriter(
						new java.io.FileWriter("C:/workspace/TP1/output/croiser_xml_json.json")));
...
// Start of branch "croiser_xml_json"
							if (croiser_xml_json != null) {
								...
								if (croiser_xml_json.Numero != null) {

									jsonRowtFileOutputJSON_1.put("Numero", croiser_xml_json.Numero);

								} else {
									jsonRowtFileOutputJSON_1.put("Numero", null);
								}

								if (croiser_xml_json.Nom != null) {

									jsonRowtFileOutputJSON_1.put("Nom", croiser_xml_json.Nom);

								} else {
									jsonRowtFileOutputJSON_1.put("Nom", null);
								}

								if (croiser_xml_json.Prenom != null) {

									jsonRowtFileOutputJSON_1.put("Prenom", croiser_xml_json.Prenom);

								} else {
									jsonRowtFileOutputJSON_1.put("Prenom", null);
								}

								if (croiser_xml_json.CIVILITE__1_M_2_Mme__3_Mlle != null) {

									jsonRowtFileOutputJSON_1.put("CIVILITE__1_M_2_Mme__3_Mlle",
											croiser_xml_json.CIVILITE__1_M_2_Mme__3_Mlle);

								} else {
									jsonRowtFileOutputJSON_1.put("CIVILITE__1_M_2_Mme__3_Mlle", null);
								}

								if (croiser_xml_json.CP != null) {

									jsonRowtFileOutputJSON_1.put("CP", croiser_xml_json.CP);

								} else {
									jsonRowtFileOutputJSON_1.put("CP", null);
								}

								if (croiser_xml_json.DATE_NAISSANCE != null) {

									jsonRowtFileOutputJSON_1.put("DATE_NAISSANCE",
											FormatterUtils.format_Date(croiser_xml_json.DATE_NAISSANCE, "dd-MM-yyyy"));

								} else {
									jsonRowtFileOutputJSON_1.put("DATE_NAISSANCE", null);
								}

								if (croiser_xml_json.Ville != null) {

									jsonRowtFileOutputJSON_1.put("Ville", croiser_xml_json.Ville);
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final xml_json_save_json xml_json_save_jsonClass = new xml_json_save_json();

		int exitCode = xml_json_save_jsonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_json_save_json.class.getClassLoader()
					.getResourceAsStream("tp1/xml_json_save_json_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_json_save_json.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_json_save_json");
		}
...
/************************************************************************************************
 * 105166 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 11:30:29 CET
 ************************************************************************************************/