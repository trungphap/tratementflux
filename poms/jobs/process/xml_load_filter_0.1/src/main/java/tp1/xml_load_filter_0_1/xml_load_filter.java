...
package tp1.xml_load_filter_0_1;
...
/**
 * Job: xml_load_filter Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class xml_load_filter implements TalendJob {
	...
	private final String jobName = "xml_load_filter";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_load_filter.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_load_filter.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_xml_load_filter = new byte[0];
		static byte[] commonByteArray_TP1_xml_load_filter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_load_filter.length) {
					if (length < 1024 && commonByteArray_TP1_xml_load_filter.length == 0) {
						commonByteArray_TP1_xml_load_filter = new byte[1024];
					} else {
						commonByteArray_TP1_xml_load_filter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_load_filter, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_filter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_load_filter, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_filter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_load_filter) {
				...
				try {
					...
					this.PREFECTURE = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.PREFECTURE, dos);
		...
		public String toString() {
			...
			sb.append(",PREFECTURE=" + PREFECTURE);
	...
	public static class departement_mapedStruct implements routines.system.IPersistableRow<departement_mapedStruct> {
		final static byte[] commonByteArrayLock_TP1_xml_load_filter = new byte[0];
		static byte[] commonByteArray_TP1_xml_load_filter = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(departement_mapedStruct other) {
	...
	public void tFileInputXML_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				departement_mapedStruct departement_maped = new departement_mapedStruct();
				...
				util_tLogRow_2.addRow(new String[] { "NUMERO", "DEPARTEMENT", "PREFECTURE", "REGION", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "departement_maped");
				}
...
// # Outputs initialization
				departement_mapedStruct departement_maped_tmp = new departement_mapedStruct();
// ###############################
				...
				try {
					filename_tFileInputXML_1 = "C:/workspace/TP1/dataset-tp1/DepartementsFR.xml";
				...
				if (isValidFile_tFileInputXML_1) {
					...
					org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1
							.createXPath(nsTool_tFileInputXML_1.addDefaultNSPrefix("/departements/departement"));
					...
					for (org.dom4j.Node temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						...
						try {
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row1.NUMERO = str_tFileInputXML_1;
							}
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row1.DEPARTEMENT = str_tFileInputXML_1;
							}
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								row1.PREFECTURE = null;
							} else if (xml_api_tFileInputXML_1.isEmpty(node_tFileInputXML_1)) {
								row1.PREFECTURE = "";
							} else if (xml_api_tFileInputXML_1.isMissing(node_tFileInputXML_1)) {
								row1.PREFECTURE = null;
							} else {
								row1.PREFECTURE = str_tFileInputXML_1;
							}
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row1.REGION = str_tFileInputXML_1;
							}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								departement_maped = null;

// # Output table : 'departement_maped'
								departement_maped_tmp.NUMERO = Integer
										.parseInt(row1.NUMERO.replace("A", "0").replace("B", "0"));
								departement_maped_tmp.DEPARTEMENT = row1.DEPARTEMENT;
								departement_maped_tmp.PREFECTURE = row1.PREFECTURE == null ? ""
										: row1.PREFECTURE.toUpperCase();
								departement_maped_tmp.REGION = row1.REGION == null ? "" : row1.REGION.toUpperCase();
								departement_maped = departement_maped_tmp;
// ###############################
							 ...
							 */
// Start of branch "departement_maped"
							if (departement_maped != null) {
								...
								ope_tFilterRow_2.matches(
										(departement_maped.NUMERO == null ? false
												: departement_maped.NUMERO.compareTo(
														ParserUtils.parseTo_Integer(String.valueOf(20))) > 0),
										"NUMERO.compareTo(20) > 0 failed");

								if (ope_tFilterRow_2.getMatchFlag()) {
									if (row2 == null) {
										row2 = new row2Struct();
									}
									row2.NUMERO = departement_maped.NUMERO;
									row2.DEPARTEMENT = departement_maped.DEPARTEMENT;
									row2.PREFECTURE = departement_maped.PREFECTURE;
									row2.REGION = departement_maped.REGION;
...
///////////////////////		
									...
									if (row2.NUMERO != null) { //
										row_tLogRow_2[0] = String.valueOf(row2.NUMERO);

									} //

									if (row2.DEPARTEMENT != null) { //
										row_tLogRow_2[1] = String.valueOf(row2.DEPARTEMENT);

									} //

									if (row2.PREFECTURE != null) { //
										row_tLogRow_2[2] = String.valueOf(row2.PREFECTURE);

									} //

									if (row2.REGION != null) { //
										row_tLogRow_2[3] = String.valueOf(row2.REGION);
...
///////////////////////    			
							...
							} // End of branch "departement_maped"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "departement_maped");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final xml_load_filter xml_load_filterClass = new xml_load_filter();

		int exitCode = xml_load_filterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_load_filter.class.getClassLoader()
					.getResourceAsStream("tp1/xml_load_filter_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_load_filter.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_load_filter");
		}
...
/************************************************************************************************
 * 77468 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 23:10:00 CET
 ************************************************************************************************/