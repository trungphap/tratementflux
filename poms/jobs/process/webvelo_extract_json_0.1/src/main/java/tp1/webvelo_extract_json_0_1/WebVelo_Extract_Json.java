...
package tp1.webvelo_extract_json_0_1;
...
/**
 * Job: WebVelo_Extract_Json Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class WebVelo_Extract_Json implements TalendJob {
	...
	private final String jobName = "WebVelo_Extract_Json";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					WebVelo_Extract_Json.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WebVelo_Extract_Json.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_WebVelo_Extract_Json = new byte[0];
		static byte[] commonByteArray_TP1_WebVelo_Extract_Json = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_WebVelo_Extract_Json.length) {
					if (length < 1024 && commonByteArray_TP1_WebVelo_Extract_Json.length == 0) {
						commonByteArray_TP1_WebVelo_Extract_Json = new byte[1024];
					} else {
						commonByteArray_TP1_WebVelo_Extract_Json = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_WebVelo_Extract_Json, 0, length);
				strReturn = new String(commonByteArray_TP1_WebVelo_Extract_Json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_WebVelo_Extract_Json, 0, length);
				strReturn = new String(commonByteArray_TP1_WebVelo_Extract_Json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_WebVelo_Extract_Json) {
	...
	public void tRESTClient_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File("C:/workspace/TP1/output/amien.csv"))
							...
							if (!isStructError_tExtractJSONFields_1) {
								...
								try {
									...
									try {
										...
										row2.longitude = value_tExtractJSONFields_1 == null ?
...
// Start of branch "row2"
							if (row2 != null) {
								...
								if (row2.number != null) {
									sb_tFileOutputDelimited_2.append(row2.number);
								}
								...
								if (row2.address != null) {
									sb_tFileOutputDelimited_2.append(row2.address);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row2.latitude != null) {
									sb_tFileOutputDelimited_2.append(row2.latitude);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row2.longitude != null) {
									sb_tFileOutputDelimited_2.append(row2.longitude);
								}
...
// [tRESTCliend_end]
	...
	public static void main(String[] args) {
		final WebVelo_Extract_Json WebVelo_Extract_JsonClass = new WebVelo_Extract_Json();

		int exitCode = WebVelo_Extract_JsonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WebVelo_Extract_Json.class.getClassLoader()
					.getResourceAsStream("tp1/webvelo_extract_json_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WebVelo_Extract_Json.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : WebVelo_Extract_Json");
		}
...
/************************************************************************************************
 * 67200 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 16:34:44 CET
 ************************************************************************************************/