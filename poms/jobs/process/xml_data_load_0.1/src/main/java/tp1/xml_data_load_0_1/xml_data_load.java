 ...
 * @status
 */
public class xml_data_load implements TalendJob {
	...
	private final String jobName = "xml_data_load";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_data_load.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_data_load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_xml_data_load = new byte[0];
		static byte[] commonByteArray_TP1_xml_data_load = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_data_load.length) {
					if (length < 1024 && commonByteArray_TP1_xml_data_load.length == 0) {
						commonByteArray_TP1_xml_data_load = new byte[1024];
					} else {
						commonByteArray_TP1_xml_data_load = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_data_load, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_data_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_data_load, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_data_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_data_load) {
...
public void tFileInputXML_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"CODE_DU_SALARIE","NB_ENFANTS","SERVICE","SALAIRE_MENSUEL",});        
...
try {
	filename_tFileInputXML_2 = "C:/workspace/TP1/dataset-tp1/DepartementsFR.xml";
...
org.dom4j.XPath x_tFileInputXML_2 = doc_tFileInputXML_2.createXPath(nsTool_tFileInputXML_2.addDefaultNSPrefix("/bills/bill/line"));  
...
java.util.Map<Integer,org.dom4j.XPath> xpaths_tFileInputXML_2=new java.util.HashMap<Integer,org.dom4j.XPath>();
	...
	org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix(,"/bills/bill/line"));
	xpath_0.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(0,xpath_0);
			
	org.dom4j.XPath xpath_1 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix(,"/bills/bill/line"));
	xpath_1.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(1,xpath_1);
			
	org.dom4j.XPath xpath_2 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix(,"/bills/bill/line"));
	xpath_2.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(2,xpath_2);
			
	org.dom4j.XPath xpath_3 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix(,"/bills/bill/line"));
...
for (org.dom4j.Node temp_tFileInputXML_2: nodeList_tFileInputXML_2) {
    ...
    if(obj0_tFileInputXML_2 == null) {
		...
		row1.CODE_DU_SALARIE = ParserUtils.parseTo_Integer(str_tFileInputXML_2);
	}
    ...
    if(obj1_tFileInputXML_2 == null) {
		...
		row1.NB_ENFANTS = ParserUtils.parseTo_Integer(str_tFileInputXML_2);
	}
    ...
    if(obj2_tFileInputXML_2 == null) {
		...
		row1.SERVICE = str_tFileInputXML_2;
	}
    ...
    if(obj3_tFileInputXML_2 == null) {
		...
		row1.SALAIRE_MENSUEL = ParserUtils.parseTo_Float(str_tFileInputXML_2);
	} 
...
///////////////////////		
	    		...
	    		if(row1.CODE_DU_SALARIE != null) { //              
                 row_tLogRow_2[0]=    						    
				                String.valueOf(row1.CODE_DU_SALARIE)			
					          ;	
	    		...
	    		if(row1.NB_ENFANTS != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(row1.NB_ENFANTS)			
					          ;	
	    		...
	    		if(row1.SALAIRE_MENSUEL != null) { //              
                 row_tLogRow_2[3]=    						
								FormatterUtils.formatUnwithE(row1.SALAIRE_MENSUEL)
					          ;	
 ...
 */
	...
	public static void main(String[] args) {
		final xml_data_load xml_data_loadClass = new xml_data_load();

		int exitCode = xml_data_loadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_data_load.class.getClassLoader()
					.getResourceAsStream("tp1/xml_data_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_data_load.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_data_load");
		}
...
/************************************************************************************************
 * 56990 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 22:07:39 CET
 ************************************************************************************************/