...
package tp1.xml_csv_mysql_load_0_1;
...
/**
 * Job: xml_csv_mysql_load Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class xml_csv_mysql_load implements TalendJob {
	...
	private final String jobName = "xml_csv_mysql_load";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_csv_mysql_load.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_csv_mysql_load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class croiser_xml_csv_sqlStruct
		...
		final static byte[] commonByteArrayLock_TP1_xml_csv_mysql_load = new byte[0];
		static byte[] commonByteArray_TP1_xml_csv_mysql_load = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_csv_mysql_load.length) {
					if (length < 1024 && commonByteArray_TP1_xml_csv_mysql_load.length == 0) {
						commonByteArray_TP1_xml_csv_mysql_load = new byte[1024];
					} else {
						commonByteArray_TP1_xml_csv_mysql_load = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_csv_mysql_load, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_csv_mysql_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_csv_mysql_load, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_csv_mysql_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_csv_mysql_load) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Numero", "Nom", "Prenom", "CIVILITE__1_M_2_Mme__3_Mlle", "CP",
						"DATE_NAISSANCE", "NB_ENFANTS", "SERVICE", "SALAIRE_MENSUEL", "Ville", });
...
///////////////////////		
								...
								if (croiser_xml_csv_sql.Numero != null) { //
									row_tLogRow_1[0] = String.valueOf(croiser_xml_csv_sql.Numero);

								} //

								if (croiser_xml_csv_sql.Nom != null) { //
									row_tLogRow_1[1] = String.valueOf(croiser_xml_csv_sql.Nom);

								} //

								if (croiser_xml_csv_sql.Prenom != null) { //
									row_tLogRow_1[2] = String.valueOf(croiser_xml_csv_sql.Prenom);

								} //

								if (croiser_xml_csv_sql.CIVILITE__1_M_2_Mme__3_Mlle != null) { //
									row_tLogRow_1[3] = String.valueOf(croiser_xml_csv_sql.CIVILITE__1_M_2_Mme__3_Mlle);

								} //

								if (croiser_xml_csv_sql.CP != null) { //
									row_tLogRow_1[4] = String.valueOf(croiser_xml_csv_sql.CP);

								} //

								if (croiser_xml_csv_sql.DATE_NAISSANCE != null) { //
									row_tLogRow_1[5] = FormatterUtils.format_Date(croiser_xml_csv_sql.DATE_NAISSANCE,
											"dd-MM-yyyy");

								} //

								if (croiser_xml_csv_sql.NB_ENFANTS != null) { //
									row_tLogRow_1[6] = String.valueOf(croiser_xml_csv_sql.NB_ENFANTS);

								} //

								if (croiser_xml_csv_sql.SERVICE != null) { //
									row_tLogRow_1[7] = String.valueOf(croiser_xml_csv_sql.SERVICE);

								} //

								if (croiser_xml_csv_sql.SALAIRE_MENSUEL != null) { //
									row_tLogRow_1[8] = FormatterUtils
											.formatUnwithE(croiser_xml_csv_sql.SALAIRE_MENSUEL);

								} //

								if (croiser_xml_csv_sql.Ville != null) { //
									row_tLogRow_1[9] = String.valueOf(croiser_xml_csv_sql.Ville);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:j+ozaRUaK6rkrDCBY3M+/GI+ZdedGExbfoVcJLN51RW3Lt2Rjw4=");
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final xml_csv_mysql_load xml_csv_mysql_loadClass = new xml_csv_mysql_load();

		int exitCode = xml_csv_mysql_loadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_csv_mysql_load.class.getClassLoader()
					.getResourceAsStream("tp1/xml_csv_mysql_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_csv_mysql_load.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_csv_mysql_load");
		}
...
/************************************************************************************************
 * 138648 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 11:08:54 CET
 ************************************************************************************************/