...
package tp1.excel_data_agregate_age_0_1;
...
/**
 * Job: excel_data_agregate_age Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_data_agregate_age implements TalendJob {
	...
	private final String jobName = "excel_data_agregate_age";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excel_data_agregate_age.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_data_agregate_age.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_excel_data_agregate_age = new byte[0];
		static byte[] commonByteArray_TP1_excel_data_agregate_age = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_excel_data_agregate_age) {
	...
	public static class mappedDataStruct implements routines.system.IPersistableRow<mappedDataStruct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_excel_data_agregate_age.length) {
					if (length < 1024 && commonByteArray_TP1_excel_data_agregate_age.length == 0) {
						commonByteArray_TP1_excel_data_agregate_age = new byte[1024];
					} else {
						commonByteArray_TP1_excel_data_agregate_age = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_excel_data_agregate_age, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_agregate_age, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_excel_data_agregate_age, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_agregate_age, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:OTkcGA9LZbeq1thH19RfEp+8lBbeEzr1ASOsyw==");
...
// # Output table : 'mappedData'
									...
									mappedData_tmp.CIVILITE__1_M_2_Mme__3_Mlle = row1.CIVILITE__1_M_2_Mme__3_Mlle;
									mappedData_tmp.CP = row1.CP;
									mappedData_tmp.Age = TalendDate.getPartOfDate("YEAR", TalendDate.getCurrentDate())
...
// Start of branch "mappedData"
								if (mappedData != null) {
									...
									operation_finder_tAggregateRow_1.Age = mappedData.Age;
...
// ###############################      
				...
				util_tLogRow_2.addRow(new String[] { "Age", "NombrePersonnes", });
...
///////////////////////		
					...
					if (row2.Age != null) { //
						row_tLogRow_2[0] = String.valueOf(row2.Age);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final excel_data_agregate_age excel_data_agregate_ageClass = new excel_data_agregate_age();

		int exitCode = excel_data_agregate_ageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_data_agregate_age.class.getClassLoader()
					.getResourceAsStream("tp1/excel_data_agregate_age_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_data_agregate_age.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : excel_data_agregate_age");
		}
...
/************************************************************************************************
 * 94743 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 10:00:30 CET
 ************************************************************************************************/