...
package tp1.json_ville_save_2mysql_0_1;
...
/**
 * Job: json_ville_save_2mysql Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class json_ville_save_2mysql implements TalendJob {
	...
	private final String jobName = "json_ville_save_2mysql";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					json_ville_save_2mysql.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(json_ville_save_2mysql.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_json_ville_save_2mysql = new byte[0];
		static byte[] commonByteArray_TP1_json_ville_save_2mysql = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_json_ville_save_2mysql.length) {
					if (length < 1024 && commonByteArray_TP1_json_ville_save_2mysql.length == 0) {
						commonByteArray_TP1_json_ville_save_2mysql = new byte[1024];
					} else {
						commonByteArray_TP1_json_ville_save_2mysql = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_json_ville_save_2mysql, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_save_2mysql, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_json_ville_save_2mysql, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_save_2mysql, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_json_ville_save_2mysql) {
	...
	public void tFileInputJSON_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "villes";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ZUxiMQ4ERM/+kYDedAMdQru+mS5jdO6q/wYsTTOOQRWYekJBTyU=");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("villes")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute(
							"CREATE TABLE `" + tableName_tDBOutput_1 + "`(`CP` INT(5)  ,`Ville` VARCHAR(17)  )");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "villes" + "` (`CP`,`Ville`) VALUES (?,?)";
...
// Start of branch "row1"
					if (row1 != null) {
						...
						if (row1.CP == null) {
							...
							pstmt_tDBOutput_1.setInt(1, row1.CP);
						}
	...
	public static void main(String[] args) {
		final json_ville_save_2mysql json_ville_save_2mysqlClass = new json_ville_save_2mysql();

		int exitCode = json_ville_save_2mysqlClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = json_ville_save_2mysql.class.getClassLoader()
					.getResourceAsStream("tp1/json_ville_save_2mysql_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = json_ville_save_2mysql.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : json_ville_save_2mysql");
		}
...
/************************************************************************************************
 * 52003 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 10:34:44 CET
 ************************************************************************************************/