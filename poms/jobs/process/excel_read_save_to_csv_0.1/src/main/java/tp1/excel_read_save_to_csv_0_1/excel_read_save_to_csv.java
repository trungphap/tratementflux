...
package tp1.excel_read_save_to_csv_0_1;
...
/**
 * Job: excel_read_save_to_csv Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_read_save_to_csv implements TalendJob {
	...
	private final String jobName = "excel_read_save_to_csv";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excel_read_save_to_csv.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_read_save_to_csv.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_excel_read_save_to_csv = new byte[0];
		static byte[] commonByteArray_TP1_excel_read_save_to_csv = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_excel_read_save_to_csv.length) {
					if (length < 1024 && commonByteArray_TP1_excel_read_save_to_csv.length == 0) {
						commonByteArray_TP1_excel_read_save_to_csv = new byte[1024];
					} else {
						commonByteArray_TP1_excel_read_save_to_csv = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_excel_read_save_to_csv, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_read_save_to_csv, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_excel_read_save_to_csv, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_read_save_to_csv, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_excel_read_save_to_csv) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File("C:/workspace/TP1/output/SalaireOutput.csv"))
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ayr594d8zSq+zN/YMn7/U/Z9V0HbVaXoapNt5Q==");
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.Numero != null) {
									sb_tFileOutputDelimited_2.append(row1.Numero);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row1.Nom != null) {
									sb_tFileOutputDelimited_2.append(row1.Nom);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row1.Prenom != null) {
									sb_tFileOutputDelimited_2.append(row1.Prenom);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row1.CIVILITE__1_M_2_Mme__3_Mlle != null) {
									sb_tFileOutputDelimited_2.append(row1.CIVILITE__1_M_2_Mme__3_Mlle);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row1.CP != null) {
									sb_tFileOutputDelimited_2.append(row1.CP);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row1.DATE_NAISSANCE != null) {
									sb_tFileOutputDelimited_2
											.append(FormatterUtils.format_Date(row1.DATE_NAISSANCE, "dd-MM-yyyy"));
								}
	...
	public static void main(String[] args) {
		final excel_read_save_to_csv excel_read_save_to_csvClass = new excel_read_save_to_csv();

		int exitCode = excel_read_save_to_csvClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_read_save_to_csv.class.getClassLoader()
					.getResourceAsStream("tp1/excel_read_save_to_csv_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_read_save_to_csv.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : excel_read_save_to_csv");
		}
...
/************************************************************************************************
 * 59744 characters generated by Talend Open Studio for Data Integration on the
 * 20 January 2024 at 23:50:35 CET
 ************************************************************************************************/