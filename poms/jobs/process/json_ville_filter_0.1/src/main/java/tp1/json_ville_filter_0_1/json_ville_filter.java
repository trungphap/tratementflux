...
package tp1.json_ville_filter_0_1;
...
/**
 * Job: json_ville_filter Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class json_ville_filter implements TalendJob {
	...
	private final String jobName = "json_ville_filter";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					json_ville_filter.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(json_ville_filter.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_json_ville_filter = new byte[0];
		static byte[] commonByteArray_TP1_json_ville_filter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_json_ville_filter.length) {
					if (length < 1024 && commonByteArray_TP1_json_ville_filter.length == 0) {
						commonByteArray_TP1_json_ville_filter = new byte[1024];
					} else {
						commonByteArray_TP1_json_ville_filter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_json_ville_filter, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_filter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_json_ville_filter, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_filter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_json_ville_filter) {
					...
					if (row1 != null) {
						...
						ope_tFilterRow_1
								.matches(
										(row1.CP == null ? false
												: row1.CP.compareTo(
														ParserUtils.parseTo_Integer(String.valueOf(30000))) < 0),
										"CP.compareTo(30000) < 0 failed");
...
///////////////////////		
							...
							if (row2.CP != null) { //
								row_tLogRow_1[0] = String.valueOf(row2.CP);

							} //

							if (row2.Ville != null) { //
								row_tLogRow_1[1] = String.valueOf(row2.Ville);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final json_ville_filter json_ville_filterClass = new json_ville_filter();

		int exitCode = json_ville_filterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = json_ville_filter.class.getClassLoader()
					.getResourceAsStream("tp1/json_ville_filter_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = json_ville_filter.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : json_ville_filter");
		}
...
/************************************************************************************************
 * 56660 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 23:50:46 CET
 ************************************************************************************************/