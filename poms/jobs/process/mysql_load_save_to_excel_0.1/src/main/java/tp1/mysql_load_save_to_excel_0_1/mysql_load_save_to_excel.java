...
package tp1.mysql_load_save_to_excel_0_1;
...
/**
 * Job: mysql_load_save_to_excel Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class mysql_load_save_to_excel implements TalendJob {
	...
	private final String jobName = "mysql_load_save_to_excel";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					mysql_load_save_to_excel.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(mysql_load_save_to_excel.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_mysql_load_save_to_excel = new byte[0];
		static byte[] commonByteArray_TP1_mysql_load_save_to_excel = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_mysql_load_save_to_excel.length) {
					if (length < 1024 && commonByteArray_TP1_mysql_load_save_to_excel.length == 0) {
						commonByteArray_TP1_mysql_load_save_to_excel = new byte[1024];
					} else {
						commonByteArray_TP1_mysql_load_save_to_excel = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_mysql_load_save_to_excel, 0, length);
				strReturn = new String(commonByteArray_TP1_mysql_load_save_to_excel, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_mysql_load_save_to_excel, 0, length);
				strReturn = new String(commonByteArray_TP1_mysql_load_save_to_excel, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_mysql_load_save_to_excel) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "C:/workspace/TP1/output/MysqlSalaireOutput.xls";
...
//create directory only if not exists
				...
				if (startRowNum_tFileOutputExcel_1 == 0) {
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_1, "CODE_DU_SALARIE"));
					// modif end
					fitWidth_tFileOutputExcel_1[0] = fitWidth_tFileOutputExcel_1[0] > 15
							? fitWidth_tFileOutputExcel_1[0]
							: 15;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(1, nb_line_tFileOutputExcel_1, "NB_ENFANTS"));
					// modif end
					fitWidth_tFileOutputExcel_1[1] = fitWidth_tFileOutputExcel_1[1] > 10
							? fitWidth_tFileOutputExcel_1[1]
							: 10;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(2, nb_line_tFileOutputExcel_1, "SERVICE"));
					// modif end
					fitWidth_tFileOutputExcel_1[2] = fitWidth_tFileOutputExcel_1[2] > 7 ? fitWidth_tFileOutputExcel_1[2]
							: 7;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(3, nb_line_tFileOutputExcel_1, "SALAIRE_MENSUEL"));
					// modif end
					fitWidth_tFileOutputExcel_1[3] = fitWidth_tFileOutputExcel_1[3] > 15
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Xvy+bKfs38t4YaXk1jeGOnQPS++guz096fA1KucwAf4MVGcl9Ro=");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.CODE_DU_SALARIE = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.NB_ENFANTS = rs_tDBInput_1.getInt(2);
							if (rs_tDBInput_1.wasNull()) {
								row1.NB_ENFANTS = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.SERVICE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.SALAIRE_MENSUEL = null;
						} else {

							row1.SALAIRE_MENSUEL = rs_tDBInput_1.getFloat(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.SALAIRE_MENSUEL = null;
							}
						}
						...
						ope_tFilterRow_1
								.matches(
										(row1.SALAIRE_MENSUEL == null ? false
												: row1.SALAIRE_MENSUEL.compareTo(
														ParserUtils.parseTo_Float(String.valueOf(2000))) > 0),
										"SALAIRE_MENSUEL.compareTo(2000) > 0 failed");
...
//modif ends							
	...
	public static void main(String[] args) {
		final mysql_load_save_to_excel mysql_load_save_to_excelClass = new mysql_load_save_to_excel();

		int exitCode = mysql_load_save_to_excelClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = mysql_load_save_to_excel.class.getClassLoader()
					.getResourceAsStream("tp1/mysql_load_save_to_excel_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = mysql_load_save_to_excel.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : mysql_load_save_to_excel");
		}
...
/************************************************************************************************
 * 60447 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 21:43:13 CET
 ************************************************************************************************/