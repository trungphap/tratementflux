...
package tp1.excel_data_ask_critere_0_1;
...
/**
 * Job: excel_data_ask_critere Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_data_ask_critere implements TalendJob {
	...
	private final String jobName = "excel_data_ask_critere";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excel_data_ask_critere.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_data_ask_critere.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				resulttMsgBox_1 = javax.swing.JOptionPane.showInputDialog(null, "Saisissez un critere", titletMsgBox_1,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("Le critere saisi est : " + (String) globalMap.get("tMsgBox_1_RESULT"));
	...
	public static void main(String[] args) {
		final excel_data_ask_critere excel_data_ask_critereClass = new excel_data_ask_critere();

		int exitCode = excel_data_ask_critereClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_data_ask_critere.class.getClassLoader()
					.getResourceAsStream("tp1/excel_data_ask_critere_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_data_ask_critere.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : excel_data_ask_critere");
		}
...
/************************************************************************************************
 * 30409 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 10:53:59 CET
 ************************************************************************************************/