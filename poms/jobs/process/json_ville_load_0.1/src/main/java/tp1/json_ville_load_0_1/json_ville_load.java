...
package tp1.json_ville_load_0_1;
...
/**
 * Job: json_ville_load Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class json_ville_load implements TalendJob {
	...
	private final String jobName = "json_ville_load";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					json_ville_load.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(json_ville_load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_json_ville_load = new byte[0];
		static byte[] commonByteArray_TP1_json_ville_load = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_json_ville_load.length) {
					if (length < 1024 && commonByteArray_TP1_json_ville_load.length == 0) {
						commonByteArray_TP1_json_ville_load = new byte[1024];
					} else {
						commonByteArray_TP1_json_ville_load = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_json_ville_load, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_json_ville_load, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_json_ville_load) {
...
///////////////////////		
						...
						if (row1.CP != null) { //
							row_tLogRow_1[0] = String.valueOf(row1.CP);

						} //

						if (row1.Ville != null) { //
							row_tLogRow_1[1] = String.valueOf(row1.Ville);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final json_ville_load json_ville_loadClass = new json_ville_load();

		int exitCode = json_ville_loadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = json_ville_load.class.getClassLoader()
					.getResourceAsStream("tp1/json_ville_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = json_ville_load.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : json_ville_load");
		}
...
/************************************************************************************************
 * 46287 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 23:24:47 CET
 ************************************************************************************************/