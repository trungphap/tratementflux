 ...
 * @status
 */
public class json_load implements TalendJob {
	...
	private final String jobName = "json_load";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(json_load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_json_load = new byte[0];
		static byte[] commonByteArray_TP1_json_load = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_json_load.length) {
					if (length < 1024 && commonByteArray_TP1_json_load.length == 0) {
						commonByteArray_TP1_json_load = new byte[1024];
					} else {
						commonByteArray_TP1_json_load = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_json_load, 0, length);
				strReturn = new String(commonByteArray_TP1_json_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_json_load, 0, length);
				strReturn = new String(commonByteArray_TP1_json_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_json_load) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final json_load json_loadClass = new json_load();

		int exitCode = json_loadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = json_load.class.getClassLoader()
					.getResourceAsStream("tp1/json_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = json_load.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : json_load");
		}
...
/************************************************************************************************
 * 47347 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 23:18:43 CET
 ************************************************************************************************/