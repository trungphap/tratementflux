...
package tp1.json_ville_minuscule_0_1;
...
/**
 * Job: json_ville_minuscule Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class json_ville_minuscule implements TalendJob {
	...
	private final String jobName = "json_ville_minuscule";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					json_ville_minuscule.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(json_ville_minuscule.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class json_mappedStruct implements routines.system.IPersistableRow<json_mappedStruct> {
		final static byte[] commonByteArrayLock_TP1_json_ville_minuscule = new byte[0];
		static byte[] commonByteArray_TP1_json_ville_minuscule = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_json_ville_minuscule.length) {
					if (length < 1024 && commonByteArray_TP1_json_ville_minuscule.length == 0) {
						commonByteArray_TP1_json_ville_minuscule = new byte[1024];
					} else {
						commonByteArray_TP1_json_ville_minuscule = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_json_ville_minuscule, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_minuscule, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_json_ville_minuscule, 0, length);
				strReturn = new String(commonByteArray_TP1_json_ville_minuscule, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_json_ville_minuscule) {
		 ...
		 * Compare keys
		 */
		public int compareTo(json_mappedStruct other) {
	...
	public void tFileInputJSON_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				json_mappedStruct json_mapped = new json_mappedStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "json_mapped");
				}
				...
				util_tLogRow_1.addRow(new String[] { "CP", "Ville", });
...
// # Outputs initialization
				json_mappedStruct json_mapped_tmp = new json_mappedStruct();
// ###############################
					...
					try {
						...
						try {
							...
							if (value_tFileInputJSON_1 != null && !value_tFileInputJSON_1.toString().isEmpty()) {
								row1.CP = ParserUtils.parseTo_Integer(value_tFileInputJSON_1.toString());
							} else {
								row1.CP =
						...
						try {
							...
							row1.Ville = value_tFileInputJSON_1 == null ?
...
// # Output table : 'json_mapped'
							json_mapped_tmp.CP = row1.CP;
							json_mapped_tmp.Ville = row1.Ville == null ? "" : row1.Ville.toLowerCase();
							json_mapped = json_mapped_tmp;
// ###############################
...
///////////////////////		
							...
							if (json_mapped.CP != null) { //
								row_tLogRow_1[0] = String.valueOf(json_mapped.CP);

							} //

							if (json_mapped.Ville != null) { //
								row_tLogRow_1[1] = String.valueOf(json_mapped.Ville);
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "json_mapped");
				}
	...
	public static void main(String[] args) {
		final json_ville_minuscule json_ville_minusculeClass = new json_ville_minuscule();

		int exitCode = json_ville_minusculeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = json_ville_minuscule.class.getClassLoader()
					.getResourceAsStream("tp1/json_ville_minuscule_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = json_ville_minuscule.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : json_ville_minuscule");
		}
...
/************************************************************************************************
 * 56270 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 23:49:15 CET
 ************************************************************************************************/