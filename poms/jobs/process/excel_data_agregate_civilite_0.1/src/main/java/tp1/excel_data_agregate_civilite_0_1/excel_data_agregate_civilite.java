...
package tp1.excel_data_agregate_civilite_0_1;
...
/**
 * Job: excel_data_agregate_civilite Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_data_agregate_civilite implements TalendJob {
	...
	private final String jobName = "excel_data_agregate_civilite";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excel_data_agregate_civilite.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_data_agregate_civilite.this,
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP1_excel_data_agregate_civilite = new byte[0];
		static byte[] commonByteArray_TP1_excel_data_agregate_civilite = new byte[0];
		...
		public Integer NombrePersonnes;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_excel_data_agregate_civilite) {
				...
				try {
					...
					this.NombrePersonnes = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.NombrePersonnes, dos);
		...
		public String toString() {
			...
			sb.append(",NombrePersonnes=" + String.valueOf(NombrePersonnes));
			sb.append("]");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_excel_data_agregate_civilite.length) {
					if (length < 1024 && commonByteArray_TP1_excel_data_agregate_civilite.length == 0) {
						commonByteArray_TP1_excel_data_agregate_civilite = new byte[1024];
					} else {
						commonByteArray_TP1_excel_data_agregate_civilite = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_excel_data_agregate_civilite, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_agregate_civilite, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_excel_data_agregate_civilite, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_agregate_civilite, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// ------------
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					Integer CIVILITE__1_M_2_Mme__3_Mlle;
					int count = 0;
					int NombrePersonnes_clmCount = 0;
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.CIVILITE__1_M_2_Mme__3_Mlle == null) ? 0
									: this.CIVILITE__1_M_2_Mme__3_Mlle.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.CIVILITE__1_M_2_Mme__3_Mlle == null) {
							if (other.CIVILITE__1_M_2_Mme__3_Mlle != null)
								return false;
						} else if (!this.CIVILITE__1_M_2_Mme__3_Mlle.equals(other.CIVILITE__1_M_2_Mme__3_Mlle))
							return false;
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:vy2m4gXdrLZgDSteord/6lU4UyPxlDDX0lRKlQ==");
...
// Start of branch "row1"
							if (row1 != null) {
								...
								operation_finder_tAggregateRow_1.CIVILITE__1_M_2_Mme__3_Mlle = row1.CIVILITE__1_M_2_Mme__3_Mlle;
								...
								if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
									...
									operation_result_tAggregateRow_1.CIVILITE__1_M_2_Mme__3_Mlle = operation_finder_tAggregateRow_1.CIVILITE__1_M_2_Mme__3_Mlle;
								...
								operation_result_tAggregateRow_1.NombrePersonnes_clmCount++;
				...
				util_tLogRow_2.addRow(new String[] { "CIVILITE__1_M_2_Mme__3_Mlle", "NombrePersonnes", });
...
///////////////////////    			
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.CIVILITE__1_M_2_Mme__3_Mlle = aggregated_row_tAggregateRow_1.CIVILITE__1_M_2_Mme__3_Mlle;
					row2.NombrePersonnes = (int) aggregated_row_tAggregateRow_1.count;
					row2.NombrePersonnes = (int) aggregated_row_tAggregateRow_1.NombrePersonnes_clmCount;
...
///////////////////////		
					...
					if (row2.CIVILITE__1_M_2_Mme__3_Mlle != null) { //
						row_tLogRow_2[0] = String.valueOf(row2.CIVILITE__1_M_2_Mme__3_Mlle);

					} //

					if (row2.NombrePersonnes != null) { //
						row_tLogRow_2[1] = String.valueOf(row2.NombrePersonnes);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final excel_data_agregate_civilite excel_data_agregate_civiliteClass = new excel_data_agregate_civilite();

		int exitCode = excel_data_agregate_civiliteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_data_agregate_civilite.class.getClassLoader()
					.getResourceAsStream("tp1/excel_data_agregate_civilite_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_data_agregate_civilite.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : excel_data_agregate_civilite");
		}
...
/************************************************************************************************
 * 82298 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 10:01:23 CET
 ************************************************************************************************/