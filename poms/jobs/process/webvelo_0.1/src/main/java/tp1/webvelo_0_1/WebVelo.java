 ...
 * @status
 */
public class WebVelo implements TalendJob {
	...
	private final String jobName = "WebVelo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WebVelo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_WebVelo = new byte[0];
		static byte[] commonByteArray_TP1_WebVelo = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_WebVelo.length) {
					if (length < 1024 && commonByteArray_TP1_WebVelo.length == 0) {
						commonByteArray_TP1_WebVelo = new byte[1024];
					} else {
						commonByteArray_TP1_WebVelo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_WebVelo, 0, length);
				strReturn = new String(commonByteArray_TP1_WebVelo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_WebVelo, 0, length);
				strReturn = new String(commonByteArray_TP1_WebVelo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_WebVelo) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final WebVelo WebVeloClass = new WebVelo();

		int exitCode = WebVeloClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WebVelo.class.getClassLoader()
					.getResourceAsStream("tp1/webvelo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WebVelo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WebVelo");
		}
...
/************************************************************************************************
 * 48995 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 19:54:54 CET
 ************************************************************************************************/