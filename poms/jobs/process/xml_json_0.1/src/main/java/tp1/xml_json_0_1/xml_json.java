 ...
 * @status
 */
public class xml_json implements TalendJob {
	...
	private final String jobName = "xml_json";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_json.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class croiser_xml_jsonStruct implements routines.system.IPersistableRow<croiser_xml_jsonStruct> {
		final static byte[] commonByteArrayLock_TP1_xml_json = new byte[0];
		static byte[] commonByteArray_TP1_xml_json = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_json.length) {
					if (length < 1024 && commonByteArray_TP1_xml_json.length == 0) {
						commonByteArray_TP1_xml_json = new byte[1024];
					} else {
						commonByteArray_TP1_xml_json = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_json, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_json, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_json, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_json) {
...
///////////////////////		
								...
								if (croiser_xml_json.Numero != null) { //
									row_tLogRow_2[0] = String.valueOf(croiser_xml_json.Numero);

								} //

								if (croiser_xml_json.Nom != null) { //
									row_tLogRow_2[1] = String.valueOf(croiser_xml_json.Nom);

								} //

								if (croiser_xml_json.Prenom != null) { //
									row_tLogRow_2[2] = String.valueOf(croiser_xml_json.Prenom);

								} //

								if (croiser_xml_json.CIVILITE__1_M_2_Mme__3_Mlle != null) { //
									row_tLogRow_2[3] = String.valueOf(croiser_xml_json.CIVILITE__1_M_2_Mme__3_Mlle);

								} //

								if (croiser_xml_json.CP != null) { //
									row_tLogRow_2[4] = String.valueOf(croiser_xml_json.CP);

								} //

								if (croiser_xml_json.DATE_NAISSANCE != null) { //
									row_tLogRow_2[5] = FormatterUtils.format_Date(croiser_xml_json.DATE_NAISSANCE,
											"dd-MM-yyyy");

								} //

								if (croiser_xml_json.Ville != null) { //
									row_tLogRow_2[6] = String.valueOf(croiser_xml_json.Ville);
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final xml_json xml_jsonClass = new xml_json();

		int exitCode = xml_jsonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_json.class.getClassLoader()
					.getResourceAsStream("tp1/xml_json_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_json.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_json");
		}
...
/************************************************************************************************
 * 110620 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 11:26:43 CET
 ************************************************************************************************/