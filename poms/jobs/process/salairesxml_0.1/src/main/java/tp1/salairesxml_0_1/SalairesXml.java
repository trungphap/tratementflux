 ...
 * @status
 */
public class SalairesXml implements TalendJob {
	...
	private final String jobName = "SalairesXml";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SalairesXml.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_TP1_SalairesXml = new byte[0];
		static byte[] commonByteArray_TP1_SalairesXml = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_SalairesXml.length) {
					if (length < 1024 && commonByteArray_TP1_SalairesXml.length == 0) {
						commonByteArray_TP1_SalairesXml = new byte[1024];
					} else {
						commonByteArray_TP1_SalairesXml = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_SalairesXml, 0, length);
				strReturn = new String(commonByteArray_TP1_SalairesXml, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_SalairesXml, 0, length);
				strReturn = new String(commonByteArray_TP1_SalairesXml, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_SalairesXml) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String originalFileName_tFileOutputXML_1 = "C:/workspace/TP1/output/Salaires.xml";
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:9fmeVPle8yThq1ZkzScppRnCENz7N1UD3kA/vA==");
...
// # Output table : 'out1'
									out1_tmp.Numero = row1.Numero;
									out1_tmp.Nom = row1.Nom;
									out1_tmp.Prenom = row1.Prenom;
									out1_tmp.CIVILITE__1_M_2_Mme__3_Mlle = row1.CIVILITE__1_M_2_Mme__3_Mlle;
									out1_tmp.CP = Integer.parseInt(row1.CP);
									out1_tmp.DATE_NAISSANCE = row1.DATE_NAISSANCE;
									out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
								if (out1 != null) {
									...
									out_tFileOutputXML_1.write("<" + "Numero" + ">"
											+ ((out1.Numero == null) ? "" : (out1.Numero)) + "</" + "Numero" + ">");

									out_tFileOutputXML_1.newLine();
									out_tFileOutputXML_1.write("<" + "Nom" + ">"
											+ ((out1.Nom == null) ? "" : (TalendString.checkCDATAForXML(out1.Nom)))
											+ "</" + "Nom" + ">");

									out_tFileOutputXML_1.newLine();
									out_tFileOutputXML_1.write("<" + "Prenom" + ">"
											+ ((out1.Prenom == null) ? ""
													: (TalendString.checkCDATAForXML(out1.Prenom)))
											+ "</" + "Prenom" + ">");

									out_tFileOutputXML_1.newLine();
									out_tFileOutputXML_1.write("<" + "CIVILITE__1_M_2_Mme__3_Mlle" + ">"
											+ ((out1.CIVILITE__1_M_2_Mme__3_Mlle == null) ? ""
													: (out1.CIVILITE__1_M_2_Mme__3_Mlle))
											+ "</" + "CIVILITE__1_M_2_Mme__3_Mlle" + ">");

									out_tFileOutputXML_1.newLine();
									out_tFileOutputXML_1.write("<" + "CP" + ">" + ((out1.CP == null) ? "" : (out1.CP))
											+ "</" + "CP" + ">");

									out_tFileOutputXML_1.newLine();
									out_tFileOutputXML_1.write("<" + "DATE_NAISSANCE" + ">"
											+ ((out1.DATE_NAISSANCE == null) ? ""
													: (TalendString.checkCDATAForXML(FormatterUtils
															.format_Date(out1.DATE_NAISSANCE, "dd-MM-yyyy"))))
											+ "</" + "DATE_NAISSANCE" + ">");
...
// ###############################      
	...
	public static void main(String[] args) {
		final SalairesXml SalairesXmlClass = new SalairesXml();

		int exitCode = SalairesXmlClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SalairesXml.class.getClassLoader()
					.getResourceAsStream("tp1/salairesxml_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SalairesXml.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SalairesXml");
		}
...
/************************************************************************************************
 * 68877 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 11:03:46 CET
 ************************************************************************************************/