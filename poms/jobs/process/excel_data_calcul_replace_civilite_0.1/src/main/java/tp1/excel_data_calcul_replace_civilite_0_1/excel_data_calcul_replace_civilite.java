...
package tp1.excel_data_calcul_replace_civilite_0_1;
...
/**
 * Job: excel_data_calcul_replace_civilite Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_data_calcul_replace_civilite implements TalendJob {
	...
	private final String jobName = "excel_data_calcul_replace_civilite";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excel_data_calcul_replace_civilite.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_data_calcul_replace_civilite.this,
	...
	public static class mappedDataStruct implements routines.system.IPersistableRow<mappedDataStruct> {
		final static byte[] commonByteArrayLock_TP1_excel_data_calcul_replace_civilite = new byte[0];
		static byte[] commonByteArray_TP1_excel_data_calcul_replace_civilite = new byte[0];
		...
		public String CIVILITE__1_M_2_Mme__3_Mlle;

		public String getCIVILITE__1_M_2_Mme__3_Mlle() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_excel_data_calcul_replace_civilite.length) {
					if (length < 1024 && commonByteArray_TP1_excel_data_calcul_replace_civilite.length == 0) {
						commonByteArray_TP1_excel_data_calcul_replace_civilite = new byte[1024];
					} else {
						commonByteArray_TP1_excel_data_calcul_replace_civilite = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_excel_data_calcul_replace_civilite, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_calcul_replace_civilite, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_excel_data_calcul_replace_civilite, 0, length);
				strReturn = new String(commonByteArray_TP1_excel_data_calcul_replace_civilite, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_excel_data_calcul_replace_civilite) {
				...
				try {
					...
					this.CIVILITE__1_M_2_Mme__3_Mlle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.CIVILITE__1_M_2_Mme__3_Mlle, dos);
		...
		public String toString() {
			...
			sb.append(",CIVILITE__1_M_2_Mme__3_Mlle=" + CIVILITE__1_M_2_Mme__3_Mlle);
			sb.append(",CP=" + CP);
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "mappedData");
				}
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:pd8GHMC84P4yszT0i2uzVr0EzXiVhJM//aitXA==");
...
// # Output table : 'mappedData'
									mappedData_tmp.Numero = row1.Numero;
									mappedData_tmp.Nom = row1.Nom.toUpperCase();
									mappedData_tmp.Prenom = row1.Prenom.toUpperCase();
									mappedData_tmp.CIVILITE__1_M_2_Mme__3_Mlle = row1.CIVILITE__1_M_2_Mme__3_Mlle == 1
											? "M"
											: row1.CIVILITE__1_M_2_Mme__3_Mlle == 2 ? "Mme" : "Mlle";
									mappedData_tmp.CP = row1.CP;
									mappedData_tmp.DATE_NAISSANCE = row1.DATE_NAISSANCE;
...
///////////////////////		
									...
									if (mappedData.Numero != null) { //
										row_tLogRow_2[0] = String.valueOf(mappedData.Numero);

									} //

									if (mappedData.Nom != null) { //
										row_tLogRow_2[1] = String.valueOf(mappedData.Nom);

									} //

									if (mappedData.Prenom != null) { //
										row_tLogRow_2[2] = String.valueOf(mappedData.Prenom);

									} //

									if (mappedData.CIVILITE__1_M_2_Mme__3_Mlle != null) { //
										row_tLogRow_2[3] = String.valueOf(mappedData.CIVILITE__1_M_2_Mme__3_Mlle);

									} //

									if (mappedData.CP != null) { //
										row_tLogRow_2[4] = String.valueOf(mappedData.CP);

									} //

									if (mappedData.DATE_NAISSANCE != null) { //
										row_tLogRow_2[5] = FormatterUtils.format_Date(mappedData.DATE_NAISSANCE,
												"dd-MM-yyyy");
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "mappedData");
				}
	...
	public static void main(String[] args) {
		final excel_data_calcul_replace_civilite excel_data_calcul_replace_civiliteClass = new excel_data_calcul_replace_civilite();

		int exitCode = excel_data_calcul_replace_civiliteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_data_calcul_replace_civilite.class.getClassLoader()
					.getResourceAsStream(
							"tp1/excel_data_calcul_replace_civilite_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_data_calcul_replace_civilite.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : excel_data_calcul_replace_civilite");
		}
 ...
 * 21 January 2024 at 09:39:02 CET
 ************************************************************************************************/