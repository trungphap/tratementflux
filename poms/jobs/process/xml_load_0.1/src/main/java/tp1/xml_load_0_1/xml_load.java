 ...
 * @status
 */
public class xml_load implements TalendJob {
	...
	private final String jobName = "xml_load";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TP1_xml_load = new byte[0];
		static byte[] commonByteArray_TP1_xml_load = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_load.length) {
					if (length < 1024 && commonByteArray_TP1_xml_load.length == 0) {
						commonByteArray_TP1_xml_load = new byte[1024];
					} else {
						commonByteArray_TP1_xml_load = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_load, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_load, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_load) {
...
///////////////////////		
							...
							if (row1.NUMERO != null) { //
								row_tLogRow_1[0] = String.valueOf(row1.NUMERO);

							} //

							if (row1.DEPARTEMENT != null) { //
								row_tLogRow_1[1] = String.valueOf(row1.DEPARTEMENT);

							} //

							if (row1.PREFECTURE != null) { //
								row_tLogRow_1[2] = String.valueOf(row1.PREFECTURE);

							} //

							if (row1.REGION != null) { //
								row_tLogRow_1[3] = String.valueOf(row1.REGION);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final xml_load xml_loadClass = new xml_load();

		int exitCode = xml_loadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_load.class.getClassLoader()
					.getResourceAsStream("tp1/xml_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_load.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_load");
		}
...
/************************************************************************************************
 * 55028 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 22:26:53 CET
 ************************************************************************************************/