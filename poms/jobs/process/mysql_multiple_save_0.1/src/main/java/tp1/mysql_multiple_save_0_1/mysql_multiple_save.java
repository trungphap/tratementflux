...
package tp1.mysql_multiple_save_0_1;
...
/**
 * Job: mysql_multiple_save Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class mysql_multiple_save implements TalendJob {
	...
	private final String jobName = "mysql_multiple_save";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					mysql_multiple_save.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(mysql_multiple_save.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_TP1_mysql_multiple_save = new byte[0];
		static byte[] commonByteArray_TP1_mysql_multiple_save = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_mysql_multiple_save.length) {
					if (length < 1024 && commonByteArray_TP1_mysql_multiple_save.length == 0) {
						commonByteArray_TP1_mysql_multiple_save = new byte[1024];
					} else {
						commonByteArray_TP1_mysql_multiple_save = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_mysql_multiple_save, 0, length);
				strReturn = new String(commonByteArray_TP1_mysql_multiple_save, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_mysql_multiple_save, 0, length);
				strReturn = new String(commonByteArray_TP1_mysql_multiple_save, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_mysql_multiple_save) {
...
//create directory only if not exists
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:BkGvRnLwGn2H2XlRazJye3Y/9f98i+xlQinbwx6WJvxflBkN11U=");
...
// for output
						...
						row3.CODE_DU_SALARIE = row1.CODE_DU_SALARIE;
						row3.NB_ENFANTS = row1.NB_ENFANTS;
						row3.SERVICE = row1.SERVICE;
						row3.SALAIRE_MENSUEL = row1.SALAIRE_MENSUEL;
...
//modif ends							
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:rj0p8bmgYMBacZDlHRhZfYLNvGWb+Vxp6NJ3lKbBPnZB7StnyVs=");
...
// for output
						...
						row3.CODE_DU_SALARIE = row2.CODE_DU_SALARIE;
						row3.NB_ENFANTS = row2.NB_ENFANTS;
						row3.SERVICE = row2.SERVICE;
						row3.SALAIRE_MENSUEL = row2.SALAIRE_MENSUEL;
...
//modif ends							
	...
	public static void main(String[] args) {
		final mysql_multiple_save mysql_multiple_saveClass = new mysql_multiple_save();

		int exitCode = mysql_multiple_saveClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = mysql_multiple_save.class.getClassLoader()
					.getResourceAsStream("tp1/mysql_multiple_save_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = mysql_multiple_save.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : mysql_multiple_save");
		}
...
/************************************************************************************************
 * 76188 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 00:12:51 CET
 ************************************************************************************************/