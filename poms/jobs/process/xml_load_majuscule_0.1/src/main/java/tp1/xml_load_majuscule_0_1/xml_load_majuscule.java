...
package tp1.xml_load_majuscule_0_1;
...
/**
 * Job: xml_load_majuscule Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class xml_load_majuscule implements TalendJob {
	...
	private final String jobName = "xml_load_majuscule";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					xml_load_majuscule.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xml_load_majuscule.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class departement_mapedStruct implements routines.system.IPersistableRow<departement_mapedStruct> {
		final static byte[] commonByteArrayLock_TP1_xml_load_majuscule = new byte[0];
		static byte[] commonByteArray_TP1_xml_load_majuscule = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP1_xml_load_majuscule.length) {
					if (length < 1024 && commonByteArray_TP1_xml_load_majuscule.length == 0) {
						commonByteArray_TP1_xml_load_majuscule = new byte[1024];
					} else {
						commonByteArray_TP1_xml_load_majuscule = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP1_xml_load_majuscule, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_majuscule, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP1_xml_load_majuscule, 0, length);
				strReturn = new String(commonByteArray_TP1_xml_load_majuscule, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP1_xml_load_majuscule) {
...
// # Output table : 'departement_maped'
								departement_maped_tmp.NUMERO = row1.NUMERO;
								departement_maped_tmp.DEPARTEMENT = row1.DEPARTEMENT;
								departement_maped_tmp.PREFECTURE = row1.PREFECTURE.toUpperCase();
								departement_maped_tmp.REGION = row1.REGION.toUpperCase();
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final xml_load_majuscule xml_load_majusculeClass = new xml_load_majuscule();

		int exitCode = xml_load_majusculeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xml_load_majuscule.class.getClassLoader()
					.getResourceAsStream("tp1/xml_load_majuscule_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = xml_load_majuscule.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : xml_load_majuscule");
		}
...
/************************************************************************************************
 * 65212 characters generated by Talend Open Studio for Data Integration on the
 * 21 January 2024 at 22:27:23 CET
 ************************************************************************************************/