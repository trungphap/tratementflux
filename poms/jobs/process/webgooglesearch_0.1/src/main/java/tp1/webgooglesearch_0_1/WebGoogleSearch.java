...
package tp1.webgooglesearch_0_1;
...
/**
 * Job: WebGoogleSearch Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class WebGoogleSearch implements TalendJob {
	...
	private final String jobName = "WebGoogleSearch";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					WebGoogleSearch.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WebGoogleSearch.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
...
try {
	...
	// set request path
	webClient_tRESTClient_1.path("maps/api/place/findplacefromtext/xml);
 ...
 */
	...
	public static void main(String[] args) {
		final WebGoogleSearch WebGoogleSearchClass = new WebGoogleSearch();

		int exitCode = WebGoogleSearchClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WebGoogleSearch.class.getClassLoader()
					.getResourceAsStream("tp1/webgooglesearch_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WebGoogleSearch.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : WebGoogleSearch");
		}
...
/************************************************************************************************
 * 32767 characters generated by Talend Open Studio for Data Integration on the
 * 27 January 2024 at 12:07:06 CET
 ************************************************************************************************/